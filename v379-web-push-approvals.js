(function(){
  'use strict';
  const VERSION='V379_WEB_PUSH_APPROVALS';
  ...
  async function subscribePush(){
    ...
    toast('התראות הופעלו. כשתהיה הזמנה לאישור תקבל Notification.');
    updateBadge();
    return true;
  }
  ...
  function injectButton(){
    ...
    wrap.querySelector('.v379-enable').onclick=async()=>{try{await subscribePush();}catch(e){console.error(e);toast('צריך להגדיר VAPID keys ב-Netlify כדי להפעיל Push אמיתי.');}};
  }
