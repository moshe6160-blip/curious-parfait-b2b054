(function(){
  ...
  function makePdfBlob(){
    ...
    line(44,764,552,764);
    txt(44,740,20,'Purchase Order',true); txt(44,721,10,new Date().toLocaleDateString(),false);
